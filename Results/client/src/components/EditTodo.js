...
const EditTodos = ({todo}) => {
    ...
    const updateDescriotion = async (e) => {
        e.preventDefault();
        try {
    ...
    <Fragment>
        ...
        <div className="modal-dialog">
            ...
            <div className="modal-header">
                ...
                <button type="button" className="close" data-bs-dismiss="modal" onClick={() => setDescription(todo.description)}>&times;</button>
            </div>
            ...
            <div className="modal-footer">
                <button type="button" className="btn btn-warning" data-bs-dismiss="modal" onClick={e => updateDescriotion(e)}>Edit</button>
